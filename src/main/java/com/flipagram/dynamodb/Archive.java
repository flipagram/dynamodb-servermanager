...
public class Archive {
	...
	public static final String CURRENT 		= "dynamodb_local_2016-04-19.tar.gz";
	public static final String VERIFY_FILE 	= "README.txt";

	public static final File DYNAMO_DB_DIRECTORY = new File(System.getProperty("java.io.tmpdir"), "dynamodb-servermanager");
